...
function NavBar() {
  ...
  return (
    <>
    <motion.div className={`flex ${t.bg} ${t.text} border-b pt-2 pb-2 border-zinc-200  justify-between items-center mt-2 mb-2`} initial={{ opacity: 0 }} animate={{ opacity: 1 }}  transition={{ 
    duration: 0.5,
    delay: 0.5,  
    ease: "easeInOut" 
  }}>
